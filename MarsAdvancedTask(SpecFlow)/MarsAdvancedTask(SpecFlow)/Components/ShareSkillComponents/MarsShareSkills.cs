...
namespace MarsAdvancedTask.Components.ShareSkillComponents
{
    ...
    //        Thread.Sleep(2000);
    //        autoIt.Send("G:\\AdvancedTask(SepcFlow)\\AdvancedTask(Eddie)\\MarsSpecFlowAdvnTask\\MarsAdvancedTask(SpecFlow)\\MarsAdvancedTask(SpecFlow)\\TestImage\\JazzImage.jpg");
    //        Thread.Sleep(1000);
    //        autoIt.Send("{ENTER}");
